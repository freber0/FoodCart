...
CREATE TABLE orders(orderId varchar(100) NOT NULL UNIQUE, purchasedDate DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, userId varchar(20) NOT NULL, PRIMARY KEY (orderId));
...
CREATE TABLE user(username VARCHAR(20) NOT NULL UNIQUE, password VARCHAR(100) NOT NULL, nom VARCHAR(20) NOT NULL, prenom VARCHAR(20) NOT NULL, email VARCHAR(40) NOT NULL, address VARCHAR(80) NOT NULL, PRIMARY KEY (username));
